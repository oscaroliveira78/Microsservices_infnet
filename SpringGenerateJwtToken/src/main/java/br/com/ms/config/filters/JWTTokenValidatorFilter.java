...
import br.com.ms.services.ErrorsJwt;
import br.com.ms.services.SecurityConstants;
import br.com.ms.services.TabelaDeErros;
...
public class JWTTokenValidatorFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
		...
		String jwt = request.getHeader(SecurityConstants.JWT_HEADER).replace("Bearer", "").trim();
		if (null != jwt) {
	...
	protected boolean shouldNotFilter(HttpServletRequest request) {
		...
		return request.getServletPath().equals("/jwt") || request.getServletPath().equals("/auth");
	}
